          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              {profile?.premiumBadge && (
                <div className="hidden xs:flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-amber-400 to-amber-600 text-black text-[8px] font-black uppercase shadow-lg shadow-amber-500/10">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-white/5 px-4 py-1.5 rounded-full border border-white/10 flex items-center gap-3">
              ...
              <div className={cn(
                ...
                profile?.premiumBadge 
                  ? "bg-gradient-to-br from-amber-400 to-amber-600 text-black border-amber-500 shadow-lg shadow-amber-500/20" 
