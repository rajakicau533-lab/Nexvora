          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              {profile?.premiumBadge && (
                <div className="hidden sm:flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black text-[10px] font-black uppercase shadow-lg shadow-amber-500/20 animate-pulse">
            ...
            {profile?.premiumBadge && (
              <div className="sm:hidden mt-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 text-black text-[9px] font-black uppercase shadow-lg shadow-amber-500/20">
                <Crown className="h-3 w-3" />
                PREMIUM
              </div>
            )}
          ...
          <Card className="premium-card rounded-3xl bg-black/40 border-white/5 overflow-hidden">
             ...
             <CardContent className="space-y-4">
                <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-between">
                   ...
                   <span className={cn("text-xs font-bold uppercase", profile?.premiumBadge ? "text-amber-500" : "text-white")}>
                     {profile?.premiumBadge ? "Premium Member" : "Regular Member"}
                   </span>
                </div>
                <div className="p-4 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-between">
                   <div className="flex items-center gap-3">
