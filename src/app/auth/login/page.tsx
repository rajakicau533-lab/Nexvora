...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Cek Eksistensi Profil & Verifikasi Admin di Firestore
      ...
      if (profileSnap.exists()) {
        ...
        // Handle account that was deleted from Firestore but exists in Auth
        console.warn("AUTH_SUCCESS_BUT_PROFILE_DELETED: Profile not found in Firestore for UID", user.uid);
        setError("Akun Anda tidak ditemukan atau telah dihapus oleh sistem. Silakan hubungi admin.");
        await signOut(auth);
        setIsLoading(false);
        return;
      }
