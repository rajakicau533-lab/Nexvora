...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Cek Referral Code dari Session
      let referredByUid = null
      const storedRefCode = sessionStorage.getItem('nexvora_ref')
      if (storedRefCode) {
      ...
      // 4. Simpan Profil User ke Firestore (users/{uid})
