...
export default function AdminDashboardPage() {
  ...
  const statItems = [
    ...
    { label: "Email Verified", value: stats.verifiedUsers.toLocaleString(), sub: "EMAIL OK", icon: MailCheck, color: "text-cyan-500", bg: "bg-cyan-500/10", loading: usersLoading },
    { label: "Email Pending", value: stats.unverifiedUsers.toLocaleString(), sub: "PENDING VERIFY", icon: MailQuestion, color: "text-slate-400", bg: "bg-white/5", loading: usersLoading },
  ...
  return (
    <div className="max-w-[1400px] mx-auto pb-6 space-y-5 animate-in fade-in duration-500">
      ...
      {/* Main Stat Grid - Optimized 3 Column Desktop */}
      ...
      <div className="grid lg:grid-cols-12 gap-5 items-start">
        ...
        {/* Right Column: Activity Logs - Balanced Height */}
