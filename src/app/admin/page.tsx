...
export default function AdminDashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    // Feature Addition: Calculate aggregate user coins
  ...
  return (
    <div className="space-y-8 max-w-[1400px] mx-auto pb-20">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-4">
        {[
          { label: "Total Koin User", value: stats.totalUserCoins.toLocaleString(), sub: "KOIN BEREDAR", icon: Wallet, color: "text-primary", bg: "bg-primary/10" },
